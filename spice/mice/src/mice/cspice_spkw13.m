%-Abstract
%
%   CSPICE_SPKW13 writes a type 13 segment to an SPK file.
%
%-Disclaimer
%
...
%
%      degree   the degree of the Hermite polynomials used to interpolate the
%               states.
%
...
%   the call:
%
%      cspice_spkw13( handle, body,   center, frame,  first,  last, ...
...
%         % Write the segment.
%         %
%         cspice_spkw13( handle,    NOBJ,           MARS,  'J2000', ...
...
%                                      'NONE',   'MARS'          );
%
%         fprintf( 'Phobos as seen from Mars\n' )
...
%
%         fprintf( 'Object 403 as seen from Mars\n' )
%         fprintf( '   Epoch       (s): %19.5f\n', et )
%         fprintf( '   Position   (km): %13.5f %13.5f %13.5f\n', ...
%                                   state(1), state(2), state(3) )
%         fprintf( '   Velocity (km/s): %13.5f %13.5f %13.5f\n', ...
...
%       call tree of this routine.
%
%   10) If the last epoch, epochs(n), where `n' is the number of
...
%       interface.
%
%   13) If the input vector arguments `states' and `epochs' do not
...
%
%-&
function cspice_spkw13( handle, body,  center, frame,  first,  ...
   ...
   switch nargin
      ...
      otherwise
         ...
         error ( ['Usage: cspice_spkw13( handle, body, center, `frame`,'  ...
   ...
   %
   try
      mice('spkw13_c', handle, body,  center, frame,  first,  ...
                       last,   segid, degree, states, epochs);
   catch spiceerr
      rethrow(spiceerr)
   end
