...
%
%               %
%               % 'bounds' represents a 3 X NCORNR array with each row
%               % a bounds vector. Extract the vectors from 'bounds'
%               % using as a vector segment.
%               %
...
%            %
%            [spoint, dist, trgepc, obspos, found] =                  ...
%                  cspice_srfxpt( METHOD, TARGET, et, ABCORR, OBSRVR, ...
%                                 dref,   dvec                        );
%
%
%            if( found )
...
%       Modified example to load the required data via a meta-kernel.
%       Added example's meta-kernel.
%
...
%
%   -Mice Version 1.0.3, 12-FEB-2015 (EDW)
%
