%-Abstract
%
%   CSPICE_DPMIN returns the value of the smallest (negative) number
...
%
%               [1,1] = size(dpmin); double = class(dpmin)
%
...
%
%         %
%         % Display the smallest negative number representable
%         % in a double precision variable.
%         %
%         fprintf( 'Minimum Double Precision Number:  %21.14e\n',          ...
%                                                    cspice_dpmin )
%
%
...
%
%
%      Minimum Double Precision Number:  -1.79769313486232e+308
%
%
%-Particulars
%
